 ...
 * created by this factory sends a bogus certificate defined in {@link SecureKeyStore}.
 * <p>
...
public final class SecureSslContextFactory {
    ...
    static {
        ...
        try {
        	...
        	logger.error("Failed to initialize the server-side SSLContext", e.getCause());
            throw new Error(
        ...
        try {
        	...
        	logger.error("Failed to initialize the client-side SSLContext", e.getCause());
            throw new Error(
