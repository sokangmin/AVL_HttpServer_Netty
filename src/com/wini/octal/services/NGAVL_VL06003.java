...
@Component
@Scope("prototype")
public class NGAVL_VL06003 extends JsonSvcIF<NGAVL_VL06003.In, NGAVL_VL06003.Out> implements Runnable {
				
		public NGAVL_VL06003(MessageEvent e, HttpRequest request) {
			this.e = e;
		...
		public class In {
			...
			/**
			 * @param tYPE_CD the tYPE_CD to set
			 */
		...
		public void run() {
			...
			try {
				...
				session.selectList("SQL.SUPPORT.NGAVL_VL06003", map);
			} catch(Exception e) {
