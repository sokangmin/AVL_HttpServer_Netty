...
@Component
@Scope("prototype")
public class NGAVL_VL06001 extends JsonSvcIF<NGAVL_VL06001.In, NGAVL_VL06001.Out> implements Runnable {
				
		public NGAVL_VL06001(MessageEvent e, HttpRequest request) {
			this.e = e;
		...
		public void run() {
			...
			try {
				...
				session.selectList("SQL.SUPPORT.NGAVL_VL06001", map);
			} catch(Exception e) {
